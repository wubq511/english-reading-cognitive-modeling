---
name: ercm-to-tickets
description: Break an approved ERCM implementation, experiment, or hybrid spec into independently verifiable GitHub evidence-slice tickets with native parent and blocking relationships. Invoke explicitly with the spec Issue or EXP file.
