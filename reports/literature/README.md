...
论文全文路径由 [`../../papers/catalog.yaml`](../../papers/catalog.yaml) 解析，旧 basename 和旧 Notion 编号由 [`../provenance/PAPER_REPORT_CROSSWALK.md`](../provenance/PAPER_REPORT_CROSSWALK.md) 解析。高风险判断应回到论文原文页码，不把深读报告当独立一手来源。
